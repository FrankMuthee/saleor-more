...
urlpatterns = patterns('',
    ...
    url(r'^product/(?P<slug>[-_\w]+)/(?P<pk>[0-9]{1,5})', ProductDetail.as_view(), name='product_detail'),
    # Order
    ...
    url(r'products/', CatalogView.as_view(), name='catalog-root'),
    ...
    #url(r'^my_orders', MyOrdersListView.as_view(), name='orders_history')
)
